...
if __name__ == "__main__":
    ...
    krams(args.TRAINING_RECORDINGS_DIR, args.ATTACK_RECORDING_PATH, WINDOW_SIZE, HOP_SIZE, BEFORE, AFTER, NUM_EPOCHS, EPOCHS_PER_CHECKPOINT, BATCH_SIZE, LEARNING_RATE, DEVICE, args.N_KEYSTROKES_IN_ATTACK)
